...
class Bhargavbank{
    ...
    public Bhargavbank(int initialA){
...
class ATM{
    ...
    private Bhargavbank account; 
    public ATM(Bhargavbank account){
        ...
        choice= input.nextInt();
          ...
          switch (choice){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Thanks for working with Bhargav Bank");
                    break;
                default:
...
public class ATMk{
    ...
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Bhargavbank userAccount = new Bhargavbank(2500);
